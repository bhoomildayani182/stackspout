...
```
cd existing_repo
git remote add origin https://open.greenhost.net/stackspin/custom-flux-example.git
git branch -M main
...
- [ ] [Set up project integrations](https://open.greenhost.net/stackspin/custom-flux-example/-/settings/integrations)
